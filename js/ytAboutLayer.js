var ytAboutLayer = (function () {
	...
	ytAboutLayer.prototype.addAboutTxt = function () {
		...
		var txtList = [
			"Person A: I wonder who the programmer of this game is?",
			"Person B: O do you mean the programmer of the game!.",
			"Person A: Yep, i mean the?",
			"Person C: don't you guys no the programmer?",
			 "His name is <<Shedrick jay>>."
		];
